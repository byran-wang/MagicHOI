...
MANO_MODEL_DIR = "./code/body_models"
SMPLX_MODEL_P = {
    "male": "./code/body_models/smplx/SMPLX_MALE.npz",
    "female": "./code/body_models/smplx/SMPLX_FEMALE.npz",
    "neutral": "./code/body_models/smplx/SMPLX_NEUTRAL.npz",
}
