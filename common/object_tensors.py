...
def construct_obj(object_model_p):
    ...
    top_sub_p = f"./arctic_data/arctic/meta/object_vtemplates/{obj_name}/top_keypoints_300.json"
    ...
    with open("./arctic_data/arctic/meta/object_meta.json", "r") as f:
...
def construct_obj_tensors(object_names):
    ...
    for k in object_names:
        object_model_p = f"./arctic_data/arctic/meta/object_vtemplates/%s" % (k)
