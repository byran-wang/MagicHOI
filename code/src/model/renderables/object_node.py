...
class ObjectNode(Node):
    def __init__(self, args, opt, sdf_bounding_sphere, node_id):
        ...
        self.v_min_max = np.array([v3d_cano.min(axis=0), v3d_cano.max(axis=0)]) * 1.3
    ...
    def sample_points(self, input):
        ...
        # fg samples to points. points in the world space.
